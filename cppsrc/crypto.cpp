...
void genprivkey(const char *seed, char **pprivstr, char **ppubstr)
{
    vector<char> privstr, pubstr;
    ...
    *pprivstr = privstr.getbuf();
    ...
    c.print(pubstr);
    pubstr.add('\0');
    *ppubstr = pubstr.getbuf();
    pubstr.disown();
}

void genpubkey(const char *privstr, char **ppubstr)
{
    vector<char> pubstr;
...
void answerchallenge(const char *privstr, const char *challenge, char **panswerstr)
{
...
void *genchallenge(void *pubkey, const void *seed, int seedlen, char **pchallengestr)
{
    ...
    challengestr.add('\0');
    *pchallengestr = challengestr.getbuf();
    challengestr.disown();
